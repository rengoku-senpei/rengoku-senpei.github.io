  ...
  return (
    <div className="bg-cyan-50 min-h-screen">
      <div className="h-full">
        ...
        <main className="flex flex-col h-3/5">
          <div className="flex flex-col bg-cyan-600 py-10">
            ...
            <div className="flex flex-col px-[20px] py-[20px] md:px-[80px] md:py-[40px] lg:px-[120px] lg:py-[40px]">
              ...
              <div className="lg:py-5 lg:px-10 lg:text-xl md:text-base text-sm font-poppins text-white indent-20 font-medium leading-8">
        ...
        <footer className="bg-cyan-900 flex flex-col h-[24vh] p-8 justify-center">
